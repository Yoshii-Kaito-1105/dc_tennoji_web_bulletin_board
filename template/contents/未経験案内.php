    ...
    <main>
        ...
        <div class="container">
            ...
            <div id="article-img">
                <h2>未経験者案内</h2>
                <h3>フロントエンドとは？</h3>
                <img src="D:\github\dc_tennoji_web_bulletin_board\image\フロントエンド画像.png" alt="">
                <h4>必要な知識/スキル</h4>
                <ul>
            ...
            <div class="backend">
                <h3>バックエンドとは？</h3>
                <img src="D:\github\dc_tennoji_web_bulletin_board\image\バックエンド画像.png" alt="">
                <h4>必要な知識/スキル</h4>
                <ul>
                    <li>プログラミングスキル</li>
            ...
            <div class="inhura">
                <h3>インフラエンジニアとは？</h3>
                <img src="D:\github\dc_tennoji_web_bulletin_board\image\インフラ画像.png"alt="">
                <h4>必要な知識/スキル</h4>
                <ul>
            ...
            <div class="game">
                <h3>ゲームエンジニアとは？</h3>
                <img src="D:\github\dc_tennoji_web_bulletin_board\image\ゲーム画像.png" alt="">
                <h4>必要な知識/スキル</h4>
                <ul>
                    <li>プログラミングスキル</li>
                    <li>ゲームエンジンのスキル</li>
